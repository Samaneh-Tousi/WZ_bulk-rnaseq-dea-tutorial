...
steps:
  - id: step1
    ...
    sections:
      - heading: "Request your VSC account"
        details: |
      ...
      - heading: "Request your introduction credits"
        details: |
      ...
      - heading: "Login to the VSC OnDemand portal"
        details: |
          Go to: [https://auth.vscentrum.be/auth/login](https://auth.vscentrum.be/auth/login)
      ...
      - heading: "Start an Interactive Shell Session"
        details: |
...
- id: step2
  title: "Connect to reserved cores, prepare workspace, load modules, and fetch data"
  description: >
  ...
  sections:
    - heading: "Connect to your reserved cores (shell/SSH)"
      details: |
    ...
    - heading: "Create your course folder under $VSC_DATA"
      details: |
    ...
    - heading: "Load required environment modules"
      details: |
    ...
    - heading: "Study data: Microglia in MS (GSE111972)"
      details: |
    ...
    - heading: "Download FASTQ files from SRA (adjust output path!)"
      details: |
    ...
    - heading: "(Optional) Organize or link into your repository"
      details: |
...
- id: step3
  title: "Downsampling FASTQ files to accelerate analysis"
  description: >
  ...
  sections:
    ...
    - heading: "Downsample to 5 million reads"
      details: |
...
- id: step4
  title: "Quality control (QC) and trimming of sub-sampled FASTQ files"
  description: >
  ...
  sections:
    ...
    - heading: "Run fastp on all sub-sampled FASTQs"
      details: |
...
- id: step5
  title: "Building the reference genome and aligning trimmed FASTQ files"
  description: >
  ...
  sections:
    - heading: "Create a reference genome directory"
      details: |
        ```bash
    ...
    - heading: "Download the reference genome and annotation (Ensembl GRCh38)"
      details: |
        ```bash
    ...
    - heading: "Generate the STAR genome index"
      details: |
        ```bash
        STAR --runThreadN 8 \
...
- id: step6
  title: "Aligning trimmed FASTQ files to the reference genome using STAR"
  description: >
  ...
  sections:
    - heading: "Set directories and load STAR"
      details: |
        ```bash
        module load STAR/2.7.3a-GCCcore-6.4.0
    ...
    - heading: "Run STAR alignment on all trimmed FASTQ files"
      details: |
        ```bash
    ...
    - heading: "Output"
      details: |
        ...
        ```
- id: step7
  title: "Verifying library strandness from STAR gene counts"
  description: >
  ...
  sections:
    - heading: "Check strandness of aligned samples"
      details: |
...
- id: step8
  title: "Counting reads per gene using featureCounts (reverse-stranded libraries)"
  description: >
  ...
  sections:
    - heading: "Load the Subread module"
      details: |
        ```bash
        module load Subread
        ```

    - heading: "Set paths and run featureCounts"
      details: |
        ```bash
    ...
    - heading: "Convert to a clean count matrix (tab-delimited)"
      details: |
        ```bash
        awk 'NR==2{
                printf "gene"
...
- id: step9
  title: "Switch to RStudio Server and run DEA (DESeq2) + GSEA"
  description: >
